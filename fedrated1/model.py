...
# ------------------ Build Model ------------------
def build_model(input_shape ,num_microbatches=256, learning_rate=0.001):
    ...
    print(f"  L1 regularization: {l1_reg:.6f}")
  ...
  # Set loss reduction to NONE for per-sample losses (important for DP)
